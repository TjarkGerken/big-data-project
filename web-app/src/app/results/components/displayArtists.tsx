          ...
          >
            ...
            <div className={"flex flex-col px-4"}>
              ...
              <div className={"py-8 flex flex-col justify-center"}>
                ...
                <p className={"font-bold text-7xl text-spotify-green text-center"}>
                  {Math.round(artistsDisplayData[0].total_msPlayed / 3600000)}{" "}
                  <span className={"text-white"}>
    {Math.round(artistsDisplayData[0].total_msPlayed / 3600000) === 1 ? "hour" : "hours"}
  </span>
                </p>
              </div>
            </div>
          ...
          {artistsDisplayData.slice(1, count).map((artist, index) => (
            ...
            >
              ...
              >
                ...
                <span className={"text-white"}>
                {Math.round(artist.total_msPlayed / 3600000) === 1 ? "hour" : "hours"}
                </span>
              </p>
            </div>
          ))}
      ...
      {artistsDisplayData.length === 0 && (
          <div role="status" className={"flex flex-col py-24 justify-center items-center w-full"}>
